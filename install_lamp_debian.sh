...
# PHP7
# apt install php php7.1-common libapache2-mod-php php-curl php7.1-curl php7.1-dev php7.1-gd php7.1-intl php7.1-mcrypt php7.1-mbstring php7.1-mysql php7.1-pspell php7.1-recode php7.1-xml php-imagick php-pear php-gettext -y
apt install php php-common libapache2-mod-php php-curl php-dev php-gd php-gettext php-imagick php-intl php-mbstring php-mcrypt php-mysql php-pear php-pspell php-recode php-xml -y
